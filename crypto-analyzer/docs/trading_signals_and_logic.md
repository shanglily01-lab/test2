...
**维度1: 15M EMA方向支持 (25分)**
- 做多: EMA9 > EMA26 → 25分，否则0分
- 做空: EMA9 < EMA26 → 25分，否则0分
- **意义**: 趋势方向是否仍然保持

**维度2: 15M EMA差值强度 (0-25分)**
| EMA差值 | 得分 | 趋势状态 |
|---------|------|---------|
| ≥ 2.5% | 25分 | 强趋势 |
| ≥ 2.0% | 20分 | 达到入场门槛 |
...
**维度4: 1H多周期一致性 (25分)**
- 做多: 1H EMA9 > EMA26 → 25分，否则0分
- 做空: 1H EMA9 < EMA26 → 25分，否则0分
- **意义**: 更大周期是否仍支持当前方向
...
**正常趋势 (分数70)**:
```
[V3趋势监控] BTC/USDT 评分=70/100 方向=support 强度=2.35%
(入场2.10% 比例1.12) 变化=acceleration 1H=✓ 盈亏=+1.85%
[V3趋势监控] BTC/USDT 🟢 趋势正常 score=70
```

**趋势减弱触发平仓 (分数45)**:
```
[V3趋势监控] ETH/USDT 评分=45/100 方向=support 强度=1.15%
(入场2.05% 比例0.56) 变化=severe_weakening 1H=✓ 盈亏=+0.65%
[V3趋势监控] ETH/USDT 🟡 趋势减弱 score=45
[V3趋势监控] ETH/USDT 🟡 触发平仓! 趋势减弱
score=45, 比例=0.56, 盈亏=+0.65%
```

**趋势崩溃立即平仓 (分数15)**:
```
[V3趋势监控] SOL/USDT 评分=15/100 方向=reverse 强度=0.35%
(入场2.20% 比例0.16) 变化=collapsing 1H=✗ 盈亏=-1.25%
[V3趋势监控] SOL/USDT 🔴 趋势崩溃! score=15
[V3趋势监控] SOL/USDT 🔴 触发平仓! 趋势崩溃
score=15, 方向=reverse, 变化=collapsing, 盈亏=-1.25%
```
