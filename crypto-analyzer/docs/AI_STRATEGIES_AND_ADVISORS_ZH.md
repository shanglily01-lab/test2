...
> 文档版本：2026-08-23 · 与 [`REQUIREMENTS_LOGIC_ZH.md`](./REQUIREMENTS_LOGIC_ZH.md) **v4.5.49** 对齐  
...
**主路径（已落地）**：REQ-BRAIN — **盈利 KPI**；A1 只认趋势新高回踩（`15m_trend_high_pullback`）；反弹/不过前高走 B3；Big4 LONG **禁 A2/B2、放行 B3/C4 滞涨空与 C1 破位跟风（小仓）**；A2/B2 仅非多头宏观精准确认后开空；LONG≥0.75 / SHORT≥0.90（C1 放量破位≥0.80）；**A1 豁免 5m**，其它 5m(40U/4根) + -80U + trail（soft 关；§7.3）。  
