...
> 文档版本：2026-08-21 · 与 [`REQUIREMENTS_LOGIC_ZH.md`](./REQUIREMENTS_LOGIC_ZH.md) **v4.5.38** 对齐  
> **给人看的对照**：[`BRAIN_AND_BREAKOUT_OPERATOR_ZH.md`](./BRAIN_AND_BREAKOUT_OPERATOR_ZH.md)  
> **合约自选 §7.5**：`/watchlist` 手动限价/市价；限价可撤；价格浏览器直连币安合约 WS；`manual_watchlist` 随实盘总开关仅 L0，成交瞬间同步。  
