...
- 收盘相对约 30 日前：涨幅 ≥ **+8%** → 偏多；跌幅 ≤ **−8%** → 偏空；其间 → 无方向  
- 日线 RSI(14)：做多需落在 **40–70**；做空需落在 **30–60**  
- 近 10 日均量 ≥ 前 20 日均量的 **0.7**（流动性不过度枯竭）

**（2）中趋势 — 约 1 周（168×1h，对照 1d）**

- 近 24 根 1h 均价 vs 近 168 根 1h 均价，方向须与大趋势一致  
- 1h RSI：做多 ≥ **45**；做空 ≤ **55**

**（3）位置与入场 — 近 4h（16×15m）+ 30×1d 高低**

- **做多（企稳）**：现价落在近 30×1d 区间 **下 20%**；近 4 根 15m 波幅 ≤ 前 12 根均值的 **0.85**；近 3 根 15m 收盘**不创新低**  
- **做空（缩量滞涨）**：现价落在近 30×1d 区间 **上 20%**；近 4 根 15m 量均 ≤ 前 12 根量均的 **0.75**；近 3 根 15m 收盘**不创新高**
