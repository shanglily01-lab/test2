...
- **入场（v4.5.22 / v4.5.35 / v4.5.47 / v4.5.48 / v4.5.49）**：A1 只开 **趋势新高回踩**（`15m_trend_high_pullback`，离高 0.80%–3.50%）；反弹/不过前高不得当 A1（走 B3）；**Big4 LONG 禁 A2/B2**；**B3/C4** 离高拒绝或不过前高即空（小仓 ×0.20）；**C1 破位跟风**（×0.35）；A2 弱反抽拒绝后开空
