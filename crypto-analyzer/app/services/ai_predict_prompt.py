...
- confidence: 0.0-1.0
- catalyst: 写清 **15m 整体趋势 + 近4~6根结构** + 量能词 + RSI(1h,可选), 至少 2 句
- data_signal: 一行量化摘要
- risk_note: 反向风险一句
"""
...
以 **15m 为核心判据**（16根=4h），结合量价、RSI(1h,辅证)、价格位置，判断能否在 4 小时内走向 {tp_pct} 目标.
...
# 判定原则 — 4 小时 / **15m 为主**
- 仅趋势延续、费率背离+**15m**拐点、突破回踩（须在 catalyst 写清 15m+量价）
- Skip: 死猫反弹、震荡、仅24h%、Big4 整池偏见、空洞 catalyst、**仅1h无15m**
