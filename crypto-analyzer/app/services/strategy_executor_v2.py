    ...
    async def execute_open_position(self, symbol: str, direction: str, signal_type: str,
        ...
        try:
            ...
            if is_dual_mode_config and not is_dual_call:
                ...
                result_forward = await self._do_open_position(
                    symbol=symbol,
                    direction=direction,
                ...
                logger.info(f"🔀 {symbol} FORWARD({direction})开仓结果: {result_forward.get('success')}")
                ...
                result_reverse = await self._do_open_position(
                    symbol=symbol,
                ...
                logger.info(f"🔀 {symbol} REVERSE({reverse_direction})开仓结果: {result_reverse.get('success')}")
