...
def test_breakout_action_opportunity() -> None:
    ...
    bounce_as_a1 = _breakout_action_opportunity(
        side="LONG",
        playbook="A1",
        edge=0.90,
        confirmed=True,
        signals={"15m_higher_low", "volume_shrink_pullback", "15m_bounce_from_low"},
        features={
            "h1_side": "LONG",
            "m15_side": "LONG",
            "ema_bull": True,
    ...
    assert b3_failed_retest_only["should_open"] is False, b3_failed_retest_only
